...
if(s.lifetime||s.planId==="lifetime"){
return{
...base,
...s,
status:"active",
...
activateSubscription(planId,options={}){
...
return{
success:false,
message:"تاريخ بداية الاشتراك غير صحيح."
}
}
...
message:
plan.lifetime
?"تم تفعيل اشتراك مدى الحياة."
:"تم تفعيل "+plan.name+" بنجاح."
}
},
...
return{
success:false,
message:"لا يوجد اشتراك لإلغائه."
}
}
...
...s,
plan,
statusText:this.getSubscriptionStatusText(),
daysLeft:this.getSubscriptionDaysLeft(),
active:this.isSubscriptionActive(),
lifetime:this.isLifetimeSubscription()
}
},
