# VAREX — الكاشير والحسابات

هذا هو النظام التشغيلي الرئيسي الحالي في VAREX. جميع الإعدادات والتعديلات محفوظة في الملفات المرتبطة أدناه.

## الدخول والإعداد الأول

- [لوحة اختيار الأنظمة](../systems.html)
- [إعداد المنشأة لأول مرة](../business-setup.html)
- [تسجيل الدخول](../login.html)
- [إنشاء حساب](../register.html)
- [تأكيد البريد الإلكتروني](../verify-email.html)
...
- [محرك VAREX الرئيسي](../varex.js)
- [التنقل والقائمة المركزية](../varex-navigation.js)
- [التصميم المركزي](../varex-theme.css)
- [طبقة الترجمة المحلية](../varex-i18n.js) و[ملفات اللغات الـ12](../locales/) — الإنجليزية افتراضيًا، دون خدمات ترجمة خارجية

## التطبيق وقاعدة البيانات

- [ملفات PWA](../manifest.json)
- [خدمة الكاش والتحديث](../sw.js)
- [تطبيق Android](../android/)
- [قاعدة البيانات وSupabase](../supabase/)
