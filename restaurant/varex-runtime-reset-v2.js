(function(){
  ...
  function showInstallButton(){
    ...
    var installColor=document.body.dataset.diningType==="restaurant"?"#B6533E":"#172554";
    button.style.cssText="position:fixed;z-index:500;inset-inline-start:18px;bottom:18px;min-height:46px;padding:10px 16px;border:1px solid #fff;border-radius:13px;background:"+installColor+";color:#fff;box-shadow:0 12px 30px rgba(0,0,0,.24);font:800 12px Arial,Tahoma,sans-serif;cursor:pointer;animation:none;transition:none";
