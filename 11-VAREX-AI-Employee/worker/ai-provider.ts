...
function systemInstruction(context: AiConversationContext) {
  ...
  return [
    ...
    "أي طلب للاتصال بشخص والتحدث معه أو سؤاله أو تحديد موعد معه يجب أن يستخدم حصراً voice / speak_on_behalf، ولا تستخدم phone / start_call أو phone / redial لهذا النوع من الطلبات. ضع هدف الحوار الكامل في message واحتفظ بالاسم أو الرقم في target.",
    "في المكالمة الصوتية لا تحوّل طلب المالك إلى نص جامد يُقرأ حرفياً؛ سلّم الهدف للموظف الصوتي كي يجري حواراً طبيعياً، يسأل الأسئلة اللازمة ويجمع التاريخ والوقت والسعر والتفاصيل المطلوبة ضمن الصلاحية.",
